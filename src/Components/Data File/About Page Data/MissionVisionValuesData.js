...
export const missionVisionData = {
  ...
  headingHighlight: "Call to Action",
  ...
  vision: {
    ...
    statement:
      "Working towards a hazards-free Afghanistan, where every individual lives free from preventable landmine/ERW hazards to build resilient communities that prioritize safety.",
  ...
  mission: {
    ...
    statement: "Removing hazards, saving lives, investing in safer futures.",
  ...
  values: {
    ...
    statement: "Humanity, Neutrality, Impartiality and Independence.",

    description:
      "Our values are grounded in the humanitarian principles of the United Nations, including humanity, neutrality, impartiality and independence. We serve to save and protect lives of all communities impacted by Landmine/and ERW throughout Afghanistan. Delivering demining services solely on need without discrimination in an unbiased manner. Acting autonomously, we address the human suffering posed by hazardous devices in an ethical and equitable manner, guided by compassion and respect for all.",
  ...
  callToAction: {
    ...
    title: "Together, We Can Build a Safer Afghanistan",
