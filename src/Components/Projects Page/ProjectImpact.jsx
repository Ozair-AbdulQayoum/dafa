      ...
      <div className="relative z-10 mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
        ...
        >
          ...
          <p className="mt-5 text-base leading-8 text-green-50/65 sm:text-lg">
            Through humanitarian mine action, DAFA continues to reduce explosive
            hazards, release safe land, and support communities across
            Afghanistan.
          </p>
        </motion.div>
        ...
        <div className="mt-14 overflow-hidden rounded-3xl border border-white/10 bg-white/5 sm:grid sm:grid-cols-2 lg:grid-cols-4">
          {impactStats.map((stat, index) => {
            ...
            return (
              <motion.div
                ...
                className="group border-b border-white/10 p-7 text-center transition-all duration-300 hover:bg-white/[0.06] sm:p-8 sm:last:border-b-0 lg:border-b-0 lg:border-r lg:last:border-r-0"
              >
                {/* Icon */}
                ...
                <p className="mx-auto mt-2 max-w-[190px] text-xs leading-5 text-green-50/45">
                  {stat.description}
                </p>
              </motion.div>
            );
        ...
        >
          ...
          <p className="text-sm leading-7 text-green-50/55">
            Every project contributes to a wider humanitarian effort to reduce
