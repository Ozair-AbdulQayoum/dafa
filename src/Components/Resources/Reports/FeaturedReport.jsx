    ...
    <section className="relative overflow-hidden bg-white py-20 sm:py-24">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
        ...
        >
          ...
          <h2 className="mt-3 text-3xl font-extrabold leading-tight tracking-[-0.02em] text-[#0F172A] sm:text-4xl lg:text-5xl">
            Latest
            <span className="text-[#087B5A]"> Report</span>
          </h2>

          <p className="mt-4 max-w-2xl text-[15px] font-normal leading-8 text-slate-600 sm:text-base">
        ...
        >
          <div className="grid lg:grid-cols-2">
              ...
              <div className="absolute inset-0 flex items-center justify-center p-8">
                <div className="relative w-full max-w-sm rotate-[-2deg] overflow-hidden rounded-lg bg-white p-8 shadow-2xl">
                  ...
                  <div className="border-l-4 border-[#F97316] pl-5">
                    ...
                    <h3 className="mt-5 text-2xl font-extrabold leading-tight tracking-[-0.02em] text-[#0F172A] sm:text-3xl">
                      Annual Report
                    </h3>
                  ...
                  <div className="mt-8 flex items-center justify-between border-t border-slate-200 pt-4">
                    ...
                    <FaFilePdf className="text-[#F97316]" size={19} />
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col justify-center p-8 sm:p-10 lg:p-14">
              ...
              <div className="flex flex-wrap items-center gap-4 text-[10px] font-bold uppercase tracking-[0.12em] text-slate-400 sm:text-[11px]">
              ...
              <h3 className="mt-6 text-3xl font-extrabold leading-[1.12] tracking-[-0.025em] text-[#0F172A] sm:text-4xl">
                DAFA Annual Report
              ...
              <p className="mt-5 max-w-xl text-[15px] font-normal leading-8 text-slate-600 sm:text-base">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <Link
                  ...
                  className="group inline-flex items-center gap-2 rounded-xl bg-[#087B5A] px-6 py-3.5 text-sm font-bold text-white transition-all duration-300 hover:bg-[#065c43] hover:shadow-lg"
                >
                  Read Report
                  <FaArrowRight
                    size={11}
                ...
                <button
                  type="button"
                  className="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-6 py-3.5 text-sm font-bold text-[#0F172A] transition-all duration-300 hover:border-[#087B5A] hover:text-[#087B5A]"
                >
                  <FaFilePdf size={13} />
                  Download PDF
                </button>
